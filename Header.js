                ...
                <Row>
                    <Col md="6" className="">
                        <div style={{ padding: "5rem 0 2rem 5rem" }}>
                            <h2>
                                Delightful C++ command line interface
                                development
                            </h2>
                            <p>
                                Cli++ provides a framework for building cli apps
                                with expressive, elegant syntax. I’ve already
                                laid the foundation — freeing you to create
                                awesome cli applications without sweating the
                                small things.
                            </p>
                        </div>
                        <div
                        ...
                        >
                            ...
                            <p>
                                ...
                                right now you need to add this path under
                                includes headers.{" "}
                            </p>
                        </div>
                        <div style={{ padding: "3rem 0rem 0rem 5rem" }}>
                            <h4 className="text-muted">
                                ...
                                cli++? The good news is that, there's{" "}
                            ...
                            <p>
                                The library is a header only library, just{" "}
                                <code>{`#include <cli++/commander>`} </code> and
                ...
                <Row>
                    ...
                    <Col>
                        <div>
                            <h2 className="mb-5">
                                ...
                                <span className="text-muted" style={{}}>
                                    {" "}
                                    and takes away the pain of options and
                                    arguments handling.
                                </span>
                            </h2>
                        </div>
                        ...
                        >
                            ...
                            >
                                cli++ is the complete solution for command line
                                development
                            </h4>
                        </div>
                        <div
                        ...
                        >
                            <h4 className="mb-2">Easy Commanding</h4>
                            <code>
                                program.command("cmd [arg]", "description")
                            </code>
                            <p className="mt-2">
                                Elegent and expressive design for defining
                ...
                <Row>
                    <Col md="6">
                        ...
                        >
                            ...
                            <code>program.version("1.0");</code>
                            <p className="mt-2">
                                prebuilt methods to help you with the comman
                                features like <code>--help</code> and{" "}
                                <code>--version</code>. Versioning has never
                                been easier with <code>.version()</code> method.
                            </p>
                        </div>
                    </Col>
                    <Col>
                        ...
                        >
                            ...
                            <p className="mt-2">
                                Simpler flag management, defined with the{" "}
                                <code>.option()</code> method, also serving as
